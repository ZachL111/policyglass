"""Regression checks for the policyglass casebook."""
...
from casebook.harness import assert_expected, policyglass_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(policyglass_summary(), assert_expected())
