...
`policyglass` is centered on security tooling work in Python. The technical target is: Lint access policies for broad grants and shadowed conditions.
...
The score is deterministic. The current threshold is 152. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 5.
