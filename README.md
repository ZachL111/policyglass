...
policyglass is a Python project for security tooling. It focuses on this technical goal: Lint access policies for broad grants and shadowed conditions.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 152, risk penalty 7, latency penalty 3, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
